...
export function statsToJSON (stats, meta) {
  return JSON.stringify({
    ...
    superficie: meta.surf ? {
      metodo: 'malhas white/pial por surface nets + Taubin sobre a parcelação DKT; espessura por transformada de distância (aproximação; não é o mris_place_surface)',
