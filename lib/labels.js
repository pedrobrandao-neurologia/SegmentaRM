...
export function groupOf (raw) {
  ...
  if (/Thalamus|Caudate|Putamen|Pallidum|Hippocampus|Amygdala|Accumbens|VentralDC|Basal-Forebrain/.test(base)) return 'subcortical'
  if (/Vermal/.test(base)) return 'cerebelo'
  // regiões corticais do protocolo BrainColor/Neuromorphometrics (AssemblyNet)
  if (/-gyrus(-medial-segment)?$|-cortex$|-insula$|-operculum$|-pole$|precuneus$|cuneus$|-area$|-polare$|-temporale$|-lobule$/.test(base)) return 'cortex'
  return 'outros'
}
